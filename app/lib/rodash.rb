# rubocop:disable all
# Rodash 1.0.0, vendored from https://github.com/SINTEF-9012/Rodash
...
class Rodash
  ...
  def self.baseSet(object, path, value, _customizer = false)
  ...
  def self.isKey(value, object)
    ...
    return !value.is_a?(Array) &&
             (@@reIsPlainProp =~ value || !@@reIsDeepProp =~ value ||
              (!object.nil? && !object.is_a?(Array) && (object.respond_to?(:has_key) && object.has_key?(value)) || (object.respond_to?(value))))
  end
