...
module BaseClientSideAppSettings
  ...
  EXPORTED_FLAGS = ["gate.publicSignUps", "gate.productAccess", "feature.facebookAds", "feature.googleAds", "feature.googleAnalytics", "feature.klaviyo", "feature.bronto"].freeze
