...
export type AppQuery = {
  ...
  /** Get a datastructure describing all the available models and fields available in the Scorpion data model */
  warehouseIntrospection: WarehouseIntrospection,
  /** Execute a query against the Scorpion data model */
